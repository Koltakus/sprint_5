...
def create_random_email():
    ...
    random_email = f'igor_koltakov_5_{random_letters}_{random.randint(100, 999)}@yandex.ru'
    return random_email
...
def create_email_base():
    random_letters = ''.join((random.choice(string.ascii_letters) for x in range(4)))
    email_base = f'igor_koltakov_5_{random_letters}_{random.randint(100, 999)}'
    return email_base